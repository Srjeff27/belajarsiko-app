...
use App\Filament\Resources\DiscussionResource\RelationManagers\CommentsRelationManager;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('google_drive_link')->label('Lampiran')->toggleable(isToggledHiddenByDefault: true)
                    ->url(fn ($record) => $record->google_drive_link, true)->openUrlInNewTab(),
