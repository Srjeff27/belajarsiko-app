...
<body class="font-sans text-gray-900 antialiased">
    <div
        class="min-h-screen flex flex-col justify-center items-center pt-6 pb-6 bg-gradient-to-br from-indigo-50 via-white to-blue-100 dark:bg-gray-900 px-4 sm:px-0">
